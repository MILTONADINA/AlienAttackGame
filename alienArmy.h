...
private:
    ...
    float fireRate = 1.0f; /**< The time in seconds between checks to fire missiles. */
    float elapsedTimeSinceLastFire = 0.0f; /**< The elapsed time since the last missile was fired. */
